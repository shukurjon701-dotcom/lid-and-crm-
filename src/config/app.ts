...
export const APP = {
  ...
  workDayHours: 8,
  /**
   * Книги ведутся отдельным разделом «Склад книг», поэтому старая статья
   * расходов с этим названием в список расходов и в метрики не попадает.
   */
  booksExpenseCategory: "Kitoblar (книги)",
} as const;
